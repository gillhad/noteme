...
ThemeData appTheme(BuildContext context,bool isDarkTheme ){
  return ThemeData(
    colorScheme: ColorScheme(
        ...
        onPrimary: isDarkTheme ?AppColors.onPrimaryDark : AppColors.onPrimary,
        secondary: isDarkTheme ? AppColors.secondaryDark : AppColors.secondary,
        onSecondary: isDarkTheme ? AppColors.onSecondaryDark : AppColors.onSecondaryDark,
        ...
        onBackground: isDarkTheme ? AppColors.onBackgroundDark : AppColors.onBackground,
        surface: isDarkTheme ? AppColors.surfaceDark : AppColors.surface,
        onSurface: isDarkTheme ?AppColors.onSurfaceDark : AppColors.onSurface),
